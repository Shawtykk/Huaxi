...
parser.add_argument('--output_dir', default = 'output_ZEI',type=str, help='output dir')                   
...
if __name__ == "__main__":
    ...
    args.img_dir = dataset_config[dataset_name]['img_dir']
    args.label_dir = dataset_config[dataset_name]['label_dir']
    args.task = dataset_config[dataset_name]['task']
